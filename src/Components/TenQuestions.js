        ...
        return (
            <React.Fragment>
                {this.props.tenQuestions ?
                    <div>
                        <h1 className="text-center"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-question" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
