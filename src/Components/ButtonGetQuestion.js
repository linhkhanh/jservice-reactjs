...
class ButtonGetQuestions extends React.Component {
  render() {
    return (
      <div className="text-center get-question col">
        <h1 className="font-weight-bold blue">Let's play</h1>
        <button onClick={this.props.getRandomQuestion} className="btn btn-outline-info">
          ...
          </svg> Random Trivia question</button>
        <button onClick={this.props.getTenQuestions} className="btn btn-outline-danger">Get 10 questions</button>
      </div>
    )
  }
}
